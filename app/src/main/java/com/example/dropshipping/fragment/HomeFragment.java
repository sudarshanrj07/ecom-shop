...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mSellAll = view.findViewById(R.id.see_all);
        mFeature = view.findViewById(R.id.fea_see_all);
        mBestSell = view.findViewById(R.id.best_sell_all);



        // BELOW CODE IS FETCHING PART
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            // here we are getter from firebase cloud

                            for (QueryDocumentSnapshot document : task.getResult()) {
                                // converting into object
                                Feature feature = document.toObject(Feature.class);
                                // adding the object to mFeatureList
        ...
        mSellAll.setOnClickListener(new View.OnClickListener() {
            @Override
